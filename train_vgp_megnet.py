...
from .megnet_vgp import ProbabilisticMEGNetModel
from .config import *

mlflow.set_tracking_uri("databricks")
mlflow.set_experiment("/Users/awm1017@ic.ac.uk/MEGNet VGP Model")
...
model = ProbabilisticMEGNetModel(
...
with mlflow.start_run(run_name="laptop_test_val"):
    mlflow.tensorflow.autolog(every_n_iter=1)
    model.train_from_structs(
